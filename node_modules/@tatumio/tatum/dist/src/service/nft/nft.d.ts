...
import { CheckTokenOwner, CreateMultiTokenNftCollection, CreateNftCollectionBase, CreateNftEvmCollection, GetAllNftTransactionsByAddress, GetAllNftTransactionsQuery, GetCollection, GetNftMetadata, GetTokenOwner, NftAddressBalance, NftTokenDetail, NftTransaction } from './nft.dto';
...
export declare class Nft {
     ...
     */
    getBalance({ page, pageSize, addresses, }: AddressBalanceDetails): Promise<ResponseDto<NftAddressBalance[]>>;
    /**
