...
export declare class SolanaRpc extends AbstractBatchRpc implements SolanaRpcSuite {
    ...
    getFeeForMessage(message: any, options?: GetCommitmentMinContextSlotOptions): Promise<JsonRpcResponse<number | null>>;
