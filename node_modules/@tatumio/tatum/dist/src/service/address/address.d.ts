import { AddressBalanceDetails, AddressBalanceFilters, AddressBalanceFiltersTron } from '../../dto';
import { ResponseDto } from '../../util';
import { AddressBalance, AddressTransaction, GetAddressTransactionsQuery, GetAddressTransactionsQueryTezos } from './address.dto';
export declare class AddressTezos {
     ...
     */
    getBalance({ addresses }: AddressBalanceFilters): Promise<ResponseDto<AddressBalance[]>>;
    /**
...
export declare class Address {
     ...
     * You can get balance of multiple addresses in one call.
     */
    getBalance({ page, pageSize, addresses, }: AddressBalanceDetails): Promise<ResponseDto<AddressBalance[]>>;
    /**
     * Get all transactions, that are related to the given address. It could be both incoming and outgoing transactions.
     */
    getTransactions({ address, transactionDirection, transactionTypes, fromBlock, toBlock, pageSize, page, }: GetAddressTransactionsQuery): Promise<ResponseDto<AddressTransaction[]>>;
