...
describe('Tatum NFT', () => {
    let client;
    beforeAll(async () => {
        client = await service_1.TatumSDK.init({
    ...
    describe('NFT owners', () => {
        ...
        it('check if NFT is owned by a specific address', async () => {
            expect(await client.nft.checkNftOwner({
                tokenAddress: '0xf31a94466dd524a9e711d5599c470b1f65b3b4d8',
                tokenId: '1',
...
describe('Tatum NFT - Tezos', () => {
    ...
    beforeAll(async () => {
        client = await service_1.TatumSDK.init({
            network: service_1.Network.TEZOS_TESTNET,
        });
    });
...
//# sourceMappingURL=tatum.nft.spec.js.map